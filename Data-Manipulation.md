...
*The mutate() function is part of the dplyr package. It is used to
create new columns or modify existing columns in a data frame without
changing the structure of the data frame*
...
*NOW USE THE PIPE OPERATOR INSTEAD* \##### `%>%` can be interpreted as
“**AND THEN**”
...
```
    ...
    ##  5 Con8  #3/5/2/2/95   28.5       <NA>                 20               0
    ##  6 Con8  #5/4/3/83/3   28         <NA>                 19               0
    ##  7 Mod7  #59           17         33.4                 19               0
    ##  8 Mod7  #103          21.4       42.1                 19               1
    ##  9 Mod7  #3/82/3-2     28         45.9                 20               0
    ## 10 Mod7  #4/2/95/2     23.5       <NA>                 19               0
    ## # ℹ 26 more rows
    ## # ℹ 1 more variable: pups_survive <dbl>
